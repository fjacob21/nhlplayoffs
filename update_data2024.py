...
from nhlquery2 import NHLQuery2

class Updater2024(Updater):

    def __init__(self, server):
        super(Updater2024, self).__init__(server, 2023)
        self._query = NHLQuery2(self._year)
