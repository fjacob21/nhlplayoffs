...
class TestPoolDataFactoryMethods(unittest.TestCase):
    ...
    def test_matchup(self):
        ...
        seasonresults = pooldatafactory.create_matchup_results(1, 0, schedule)
        playoffresults = pooldatafactory.create_matchup_results(1, 0, schedule)
        matchup = pooldatafactory.create_matchup('m', 1, 1, 2, '', playoffresults, seasonresults)
        ...
        self.assertEqual(matchup.playoff.games[0].home, 1)
        self.assertEqual(matchup.playoff.games[0].away, 2)
        self.assertEqual(matchup.playoff.games[0].date, '2017-04-10T00:41:45Z')
        self.assertEqual(matchup.playoff.games[0].state, GAME_STATE_FINISHED)
        self.assertEqual(matchup.playoff.games[0].home_goal, 1)
        self.assertEqual(matchup.playoff.games[0].away_goal, 0)
        self.assertEqual(matchup.playoff.games[0].extra_data['extra'], 'data')
        self.assertEqual(matchup.season.home_win, 1)
        self.assertEqual(matchup.season.away_win, 0)
        self.assertEqual(matchup.season.games[0].home, 1)
        self.assertEqual(matchup.season.games[0].away, 2)
        self.assertEqual(matchup.season.games[0].date, '2017-04-10T00:41:45Z')
        self.assertEqual(matchup.season.games[0].state, GAME_STATE_FINISHED)
        self.assertEqual(matchup.season.games[0].home_goal, 1)
        self.assertEqual(matchup.season.games[0].away_goal, 0)
        self.assertEqual(matchup.season.games[0].extra_data['extra'], 'data')
        self.assertEqual(matchup.playoff.home_win, 1)
        self.assertEqual(matchup.playoff.away_win, 0)
